...
/* Modified under the terms of the FIRST BSD license by Team 694 */
 ...
 * modes. You can do
 * this by putting every possible {@link Command} you want to run as an
 * autonomous into a {@link
...
public class OrderedSendableChooser<V> implements Sendable {
     ...
     */
    public OrderedSendableChooser() {
    }

    /**
     * Adds the given object to the list of options. On the
     * {@link SmartDashboard} on the desktop, the
     ...
     * very close to {@link #addObject(String, Object)} except that it will use
     * this as the default
