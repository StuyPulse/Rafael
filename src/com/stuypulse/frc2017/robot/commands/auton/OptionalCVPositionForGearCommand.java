...
/**
 * Used in autonomous to either drive a set number of inches to the boiler, if
 * the auton CV chooser on SmartDashboard was selected to not use CV in auton,
 * or to drive to the boiler with CV alignment otherwise.
 */
