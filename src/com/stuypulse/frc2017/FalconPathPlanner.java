/* Courtesy of KHEngineering, Team 2168 */
...
public class FalconPathPlanner
{
	...
	public double[][] inject(double[][] orig, int numToInject)
	{
		...
		System.out.println("intermediate points: " + Arrays.deepToString(morePoints));
	    return morePoints;
	}
	...
	public double[][] smoother(double[][] path, double weight_data, double weight_smooth, double tolerance)
	{
		...
		System.out.println("smoother path: " + Arrays.deepToString(newPath));
		return newPath;
